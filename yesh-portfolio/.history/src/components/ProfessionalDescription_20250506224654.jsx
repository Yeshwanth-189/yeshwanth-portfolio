...
const skillsRight = [
  ...
  },
  {
    ...
    description:
      "Managed source control using Microsoft Team Foundation Server (TFS) and Git to organize commits across multiple applications and environments. Participated actively in code reviews with team members and senior architects, ensuring adherence to coding standards and improving code quality. Collaborated with DevOps teams to create and maintain build artifacts for legacy application pipelines. Contributed to a code migration project, successfully transitioning source control from TFS to Git, improving scalability, productivity,& alignment with DevOps practices.",
  },
  {
    id: 8,

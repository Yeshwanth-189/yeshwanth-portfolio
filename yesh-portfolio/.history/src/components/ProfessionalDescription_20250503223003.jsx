...
const skillsLeft = [
  ...
  },
  {
    ...
    description:
      "Worked with both REST and SOAP APIs to integrate various backend services into front-end applications.Utilized Axios to build secure, robust, and scalable API communication layers.Developed third-party verification APIs, including user identity verification and background verification systems, ensuring reliability and security in critical workflowsImplemented best practices for error handling, retries, and token-based authentication (OAuth, JWT).Worked with Postman, Swagger, and API documentation tools for effective testing and collaboration.",
  },
];

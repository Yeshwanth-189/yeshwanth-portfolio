...
const descriptions = [
  ...
  },
  {
    ...
    bullets: [
      <li key="1">
        Built a hybrid recommendation system that powers personalized product
      ...
      <li key="2">
        ...
        <span className="highlight">personalized</span> product suggestions,
        <span className="highlight"> similar </span> item recommendations, and{" "}
        <span className="highlight">real-time</span> trending items using
        purchase/view behavior.
      </li>,
      <li key="3">
        Designed a <span className="highlight">cold start</span> strategy using{" "}
        <span className="highlight">intelligent</span> fallbacks to address new
        users or product data sparsity.
      </li>,
      <li key="4">
        Integrated <span className="highlight">sentiment-aware filtering</span>{" "}
        by analyzing product reviews using NLP to boost ranking accuracy and
        relevance.
      </li>,
    ],
  },
  {
    ...
    bullets: [
      <li key="1">
        ...
        <span className="highlight">computer graphics</span> simulation using
        OpenGL to visualize the{" "}
        <span className="highlight">life cycle of a star</span> — from formation
        to supernova and black hole stages.
      </li>,
      <li key="2">
        Integrated <span className="highlight">audio</span> effects using OpenAL
        to dynamically reflect each cosmic event, creating a multisensory,
        immersive experience unique among class submissions.
      </li>,
      <li key="3">
        Received commendation from the course instructor for creativity and
        technical execution of simulation to visualize{" "}
        <span className="highlight">constellations</span> around us.
      </li>,
    ],
  },
  {
    ...
    bullets: [
      <li key="1">
        ...
        with minimal training/testing time by applying Decision Tree algorithms
        on a labeled network attack dataset.
      </li>,
      <li key="2">
        ...
        <span className="highlight">probe</span> attacks enhancing cybersecurity
        threat detection using supervised ML techniques.
      </li>,
      <li key="3">
        Utilized{" "}
        <span className="highlight">feature engineering and preprocessing</span>{" "}
  ...
  },
  {
    ...
    bullets: [
      <li key="1">
        ...
        <span className="highlight">messaging</span>, and{" "}
        <span className="highlight">image sharing</span>.
      </li>,
      <li key="2">
        Implemented{" "}
        <span className="highlight">Firebase Realtime Database</span> and{" "}
        <span className="highlight">Cloud Storage</span> for scalable backend
        support.
      </li>,
      <li key="3">
        Emulated core Snapchat features such as{" "}
        <span className="highlight">ephemeral</span> messaging,{" "}
        <span className="highlight">snap</span> stories, and{" "}
        <span className="highlight">image uploads</span>.
      </li>,
    ],
  },
  {
    ...
    bullets: [
      <li key="lemon-0">
        Built a responsive, clean, and modern Restaurant Reservation System
        using ReactJS, Formik, Yup Validation, and Ant Design, resulting in a
        smoother and more intuitive{" "}
        <span className="highlight">user experience</span> for seamless table
        reservations.
      </li>,
      <li key="lemon-1">
        Enhanced <span className="highlight">booking conversion rates</span> by
        streamlining the reservation process, allowing users to make table
        reservations, fill in their personal details, and confirm their booking

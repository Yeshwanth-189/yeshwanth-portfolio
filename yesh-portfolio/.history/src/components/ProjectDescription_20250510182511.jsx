...
const descriptions = [
  {
    ...
    bullets: [
      ...
      "Built a full-stack application to automate resume parsing and job description matching, achieving a <span class='highlight'>94%</span> faster analysis compared to manual comparison.",
      "Achieved an average skill match accuracy of <span class='highlight'>82%</span> by intelligently parsing skills, experience, and education sections from user-uploaded resumes.",
    ],
  },
  {
    title: "ResumeCraft.AI (Full-Stack Application)",

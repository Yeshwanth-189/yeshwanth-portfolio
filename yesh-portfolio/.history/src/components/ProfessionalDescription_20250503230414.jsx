...
const skillsRight = [
  ...
  },
  {
    ...
    description:
      "Managed source control using Microsoft Team Foundation Server (TFS) to organize commits across multiple applications and environments (Dev, Stage, and Production).

Participated actively in code reviews with team members and senior architects, ensuring adherence to coding standards and improving code quality.

Collaborated with DevOps teams to create and maintain build artifacts for legacy application pipelines, ensuring smooth CI/CD integration.

Contributed to a code migration project, successfully transitioning source control from TFS to Git, improving scalability, developer productivity, and alignment with modern DevOps practices.",
  },
  {
    id: 8,

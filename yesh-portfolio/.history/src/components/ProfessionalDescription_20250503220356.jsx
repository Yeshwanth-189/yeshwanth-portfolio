...
const skillsLeft = [
  {
    ...
    description:
      "Built front-end interfaces for customer service platforms serving over 100,000 users globally.Spearheaded front-end development and drove UI architecture for markets in the US, UK, Canada, and India by implementing configuration file-based adaptations, enabling zero code changes, significantly improving code reusability, and enhancing performance.Experienced in working with legacy React codebases utilizing both class-based and functional components, Redux store management, Saga middleware, and libraries such as Material-UI and Ant Design.",
  },
  {
    id: 2,
    title: "UI/UX Design",

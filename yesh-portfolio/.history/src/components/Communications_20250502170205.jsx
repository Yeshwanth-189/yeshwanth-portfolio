              ...
              {activeModal === "music" && (
                <div className="music-modal-wrapper">
                  ...
                  <div className="music-modal">
                    <h2 className="music-title">My Vibe 🎵</h2>
                    <ul className="music-list">
                      <li
                        onClick={() =>
                          setSelectedBackground(gradients.blindingLights)
                        }
                      >
                      ...
                      <li
                        onClick={() =>
                          setSelectedBackground(gradients.sunflower)
                        }
                      >
                      ...
                      <li
                        onClick={() =>
                          setSelectedBackground(gradients.topOfWorld)
                        }
                      >
                      ...
                      <li
                        onClick={() =>
                          setSelectedBackground(gradients.heatWaves)
                        }
                      >
                      ...
                      <li
                        onClick={() =>
                          setSelectedBackground(gradients.vivaLaVida)
                        }
                      >

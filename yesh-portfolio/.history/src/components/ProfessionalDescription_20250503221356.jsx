...
const skillsLeft = [
  ...
  },
  {
    ...
    title: "UI/UX Design",
    description:
      "Designed user interfaces and screen layouts using Figma, collaborating closely with UI/UX teams to refine and iterate designs based on feedback.Created interactive prototypes in Figma to simulate user flows and gather early feedback, improving usability and user experience.Participated in design reviews, providing constructive input and responding to UI/UX queries to ensure seamless alignment between design and development.Translated high-fidelity Figma designs into responsive, production-ready front-end code, ensuring pixel-perfect implementation.",
  },
  {
    id: 3,

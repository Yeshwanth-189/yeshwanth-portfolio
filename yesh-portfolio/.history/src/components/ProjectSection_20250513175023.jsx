...
const dummyProjects = [
  ...
  },
  {
    ...
    demo: "https://drive.google.com/file/d/1F9AFzKSbas90WQywx32GZzwqvY5jFeKU/view?usp=drive_link",
    code: "https://github.com/Yeshwanth-189/CloudProject",
    description:
      "Built a Image Classification Model deployed on cloud using Docker and Kubernetes.",
  },
  {
    id: 3,
  ...
  {
    id: 4,
    title: "NIDS using Machine Learning",
    image: NIDS,
    skills: [
      { name: "HTML5", icon: <FaHtml5 /> },
      { name: "CSS3", icon: <FaCss3Alt /> },
    ...
    code: "#",
    description:
      "Built a Network Intrusion Detection System using Machine Learning to detect attacks.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Figma", icon: <PiFigmaLogoBold /> },
      { name: "JavaScript", icon: <FaJsSquare /> },
      { name: "Django", icon: <PiFileCSharpDuotone /> },
      { name: "MySQL", icon: <SiMysql /> },
    ],
    demo: "#",
    code: "#",

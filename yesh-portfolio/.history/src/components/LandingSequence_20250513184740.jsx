...
import DoorSound from "../assets/Door.mp3"; // Use actual audio format
import LeftDoorImage from "../assets/left-door.png";
import RightDoorImage from "../assets/right-door.png";

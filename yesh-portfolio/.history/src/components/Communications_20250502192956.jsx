...
import Casette from "../assets/Casette.mp4";
                ...
                <div className="contact-modal">
                  ...
                  <ul className="contact-list">
                    <li>
                      ...
                      <strong>Personal Email :</strong> yeshn0207@gmail.com
                    </li>
                    <li>
                      <MdEmail className="contact-icon" />
                      <strong>Academic Email :</strong> ynanj002@ucr.edu
                    </li>
                    <li>
                ...
                <div className="music-modal">
                  ...
                  <div className="album-carousel">
                    <div className="album-track">
                      ...
                      <img src={Stars} alt="Album 5" className="album-cover" />
                      <img
                        src={TillICollapseImage}
                        alt="Album 1"
                        className="album-cover"

...
const descriptions = [
  ...
  },
  {
    ...
    bullets: [
      <li>
        {"Achieved "}
        <span className="highlight">98% classification accuracy</span>
        {
          " with minimal training/testing time by applying Decision Tree algorithms on a labeled network attack dataset."
        }
      </li>,
      <li>

...
function Planet({
  ...
  useFrame(({ clock }) => {
    if (!hovered && planetRef.current) {
      ...
      planetRef.current.position.x = Math.cos(angle) * distance + 0.5;
  ...
  return (
    <div className="profession-wrapper">
      <Canvas camera={{ position: [0, 15, 30], fov: 48 }}>
        ...
        <OrbitRing radius={7} height={6.5 * 0.05} />
        <Planet
          distance={6.5}
          speed={0.45}
          label="UI/UX"
        ...
        <OrbitRing radius={8.5} height={8 * 0.05} />
        <Planet
          distance={8}
          speed={0.38}
          label="Back End"
        ...
        <OrbitRing radius={10} height={9.5 * 0.05} />
        <Planet
          distance={9.5}
          speed={0.35}
          label="API"
        ...
        <OrbitRing radius={11.5} height={11 * 0.05} />
        <Planet
          distance={11}
          speed={0.32}
          label="Agile"
        ...
        <OrbitRing radius={13} height={12.5 * 0.05} />
        <Planet
          distance={12.5}
          speed={0.25}
          label="CI/CD & Cloud"
        ...
        <OrbitRing radius={14.5} height={14 * 0.05} />
        <Planet
          distance={14}
          speed={0.2}
        ...
        <OrbitRing radius={16} height={15.5 * 0.05} />
        <Planet
          distance={15.5}
          speed={0.15}

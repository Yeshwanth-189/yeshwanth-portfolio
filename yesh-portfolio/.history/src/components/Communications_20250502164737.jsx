...
function Communications() {
  ...
  const [backgroundColor, setBackgroundColor] = useState("#1f2833");
            ...
            >
              ...
              {activeModal === "music" && (
                ...
                >
                  ...
                  <ul>
                    <li
                      onClick={() => setBackgroundColor("#66fcf1")}
                      style={{ cursor: "pointer" }}
                    >
                      Blinding Lights - The Weeknd
                    </li>
                    <li
                      onClick={() => setBackgroundColor("#45a29e")}
                      style={{ cursor: "pointer" }}
                    >
                      Sunflower - Post Malone
                    </li>
                    <li
                      onClick={() => setBackgroundColor("#0b0c10")}
                      style={{ cursor: "pointer" }}
                    >
                      On Top of the World - Imagine Dragons
                    </li>
                    <li
                      onClick={() => setBackgroundColor("#c5c6c7")}
                      style={{ cursor: "pointer" }}
                    >
                      Heat Waves - Glass Animals
                    </li>
                    <li
                      onClick={() => setBackgroundColor("#1f2833")}
                      style={{ cursor: "pointer" }}
                    >

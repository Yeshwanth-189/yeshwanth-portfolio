              ...
              {activeModal === "workPermit" && (
                {activeModal === "workPermit" && (
                    <div className="work-permit-modal">
                      <div className="work-permit-icon">🌎</div>
                      <h2>Work Authorization</h2>
                      <ul className="work-permit-list">
                        <li>✔️ F-1 OPT (Eligible for STEM Extension)</li>
                        <li>✔️ Authorized to work in the U.S. until January 2027</li>
                        <li>✔️ No sponsorship required during OPT period</li>
                        <li>✔️ Open to H-1B sponsorship for long-term employment</li>
                      </ul>
                    </div>
                  )}
              )}

...
const descriptions = [
  ...
  },
  {
    ...
    bullets: [
      <li>
        {
          "Built a responsive, clean, and modern Restaurant Reservation System using ReactJS, Formik, Yup Validation, and Ant Design, "
        }
        {"resulting in a smoother and more intuitive "}
        <span className="highlight">user experience</span>
        {" for seamless table reservations."}
      </li>,
      <li>
        {"Enhanced "}

  ...
  },
  {
    ...
    bullets: [
      <li>
        ...
        {", "}
        <span className="highlight">content-based filtering</span>
        {", and "}
      ...
      <li>
        ...
        <span className="highlight">personalized product suggestions</span>
        {", "}
        <span className="highlight">similar item recommendations</span>
        {", and "}
        <span className="highlight">real-time trending items</span>
        {" using purchase/view behavior."}
      </li>,
      <li>
        {"Designed a "}
        <span className="highlight">cold start strategy</span>
        {" using "}
        <span className="highlight">intelligent fallbacks</span>
        {" to address new users or product data sparsity."}
      </li>,
      <li>
        {"Integrated "}
        <span className="highlight">sentiment-aware filtering</span>
        {
          " by analyzing product reviews using NLP to boost ranking accuracy and relevance."
        }
      </li>,
    ],
  },

...
import { DeviconsCpp } from "react-icons/di";
const dummyProjects = [
  {
    id: 1,
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "React", icon: <FaReact /> },
      { name: "Figma", icon: <AiOutlineAppstoreAdd /> },
  ...
  },
  {
    ...
    skills: [
      { name: "VS", icon: <FaLaptopCode /> },
      { name: "Open AL", icon: <FaVolumeUp /> },
      { name: "C++", icon: <DeviconsCpp /> },
    ],
    demo: "#",
    code: "#",
    description:

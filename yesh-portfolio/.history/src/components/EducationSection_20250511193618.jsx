    ...
    <div className="edu-section">
      ...
      <div className="col-2to11">
        <div className="edu-markers">
          ...
          <div className={`planet-popup ${index % 2 === 0 ? "right" : "left"}`}>
          ...
          <div className={`planet-popup ${index % 2 === 0 ? "right" : "left"}`}>
            <img src={stoppurple} alt="Planet 1" className="marker planet" />
            <div className="planet-popup">
              <h3>Pre-University</h3>
              <p>Completed high school at XYZ Academy with distinction.</p>
            </div>
          ...
          <div className={`planet-popup ${index % 2 === 0 ? "right" : "left"}`}>
            <img src={stopyellow} alt="Planet 1" className="marker planet" />
            <div className="planet-popup">
              <h3>Pre-University</h3>
              <p>Completed high school at XYZ Academy with distinction.</p>
            </div>
          ...
          <div className={`planet-popup ${index % 2 === 0 ? "right" : "left"}`}>
            <img src={stopblue} alt="Planet 1" className="marker planet left" />
            <div className="planet-popup">
              <h3>Pre-University</h3>
              <p>Completed high school at XYZ Academy with distinction.</p>
            </div>
          ...
          <div className={`planet-popup ${index % 2 === 0 ? "right" : "left"}`}>
            <img src={stopgreen} alt="Planet 1" className="marker planet" />
            <div className="planet-popup">
              <h3>Pre-University</h3>
              <p>Completed high school at XYZ Academy with distinction.</p>
            </div>

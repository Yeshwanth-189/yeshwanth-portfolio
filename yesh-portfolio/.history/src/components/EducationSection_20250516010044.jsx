          ...
          <div className="planet-with-popup">
            ...
            >
              <div className="education-popup">
                ...
                <p className="highlight-paragraph">Sept 2024 - Dec 2025</p>
                <div>
          ...
          <div className="planet-with-popup">
            ...
            >
              <div className="education-popup">
                ...
                <p className="highlight-paragraph">Jul 2023 - Sept 2024</p>
                <div>
          ...
          <div className="planet-with-popup">
            ...
            >
              <div className="education-popup">
                ...
                <p className="highlight-paragraph">Jun 2022 - Dec 2022</p>
                <div>
                  <strong>Work:</strong>
                  <ul>
          ...
          <div className="planet-with-popup">
            ...
            >
              <div className="education-popup">
                ...
                <p className="highlight-paragraph">Aug 2019 - Jun 2023</p>
                <div>
                  <strong>Relevant Coursework:</strong>
                  <ul>
          ...
          <div className="planet-with-popup">
            ...
            >
              <div className="education-popup">
                ...
                <p className="highlight-paragraph">Jun 2017 - Jun 2019</p>
                <div>
                  <strong>Relevant Coursework:</strong>
                  <ul>
                    <li>Physics</li>

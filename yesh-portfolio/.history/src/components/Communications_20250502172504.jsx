              ...
              {activeModal === "recommendations" && (
                <div className="recommendations-modal">
                  ...
                  <div className="testimonials-list">
                    <blockquote>
                      <p>
                        "Yeshwanth quickly became a key member of the team. His
                        ability to understand complex legacy code in a short
                        time made him my go-to person for technical challenges.
                        His expertise in React development, along with his
                        ability to gain the trust of architects through his
                        teamwork and insights, had a positive impact on our
                        projects. Yeshwanth worked on many important tasks,
                        including AWS migrations and developing a web scraper
                        using Node.js in AWS Lambda. His problem-solving skills,
                        technical knowledge, and leadership in driving projects
                        were consistently impressive."
                      </p>
                      <footer>— Project Manager</footer>
                    </blockquote>

                    <blockquote>
                      <p>
                        "Yeshwanth, our code setup guy, an all-rounder. Thank
                        you bro for helping me all the time. You are a great UI
                        Developer, who also resolved backend bugs."
                      </p>
                      <footer>— Senior Backend Developer</footer>
                    </blockquote>

                    <blockquote>
                      <p>
                        "Incredibly talented individual. I admire the passion
                        and dedication you bring to your work."
                      </p>
                      <footer>— Full Stack Engineer</footer>
                    </blockquote>

                    <blockquote>
                      <p>
                        "Yeshwanth, you are a great React developer who handles
                        end-to-end UI. You have excellent product knowledge,
                        making you an invaluable asset to the team. You
                        consistently deliver high-quality work and are always
                        willing to go the extra mile to ensure our products meet
                        the highest standards. Your innovative approach and
                        problem-solving skills have significantly improved our
                        user interface and application."
                      </p>
                      <footer>— Backend Engineer</footer>
                    </blockquote>
                  </div>
                </div>
              )}

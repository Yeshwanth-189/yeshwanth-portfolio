...
function Projects() {
  ...
  const rows = [];
  for (let i = 0; i < dummyProjects.length; i += 3) {
    rows.push(dummyProjects.slice(i, i + 3));
  }
          ...
          <div className="tablet-frame">
            <div className="tablet-scroll-content">
              <div className="tablet-project-sections">
                {Array.from({
                  length: Math.ceil(dummyProjects.length / 3),
                }).map((_, rowIndex) => (
                  <div className="project-section" key={rowIndex}>
                    {dummyProjects

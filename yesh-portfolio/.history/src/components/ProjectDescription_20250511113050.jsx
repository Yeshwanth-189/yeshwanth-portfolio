...
const descriptions = [
  ...
  },
  {
    ...
    bullets: [
      <li>
        {
          "Built a responsive, clean, and modern Restaurant Reservation System using "
        }
        <span className="highlight">ReactJS</span>
        {", "}
        <span className="highlight">Formik</span>
        {", "}
        <span className="highlight">Yup </span>
        {"Validation, and "}
        <span className="highlight">Ant Design</span>
        {
          " resulting in a smoother and more intuitive user experience for seamless table reservations."
        }
      </li>,
      <li>
        {"Enhanced "}
        <span className="highlight">booking conversion rates</span>
        {
          " by streamlining the reservation process, allowing users to easily make table reservations, "
        }
        {
          "fill in their personal details, and confirm their booking with minimal friction."
        }
      </li>,
    ],
  },

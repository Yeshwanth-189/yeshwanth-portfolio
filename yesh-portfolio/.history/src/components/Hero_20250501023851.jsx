        ...
        <div className="col-2to8 hero-text">
          ...
          <p>
            ...
            <p>
              ...
              proof-of-concept initiatives, including architecting UI
              configurations for multiple countries through a zero-code-change
              config file system, and implementing AWS Lambda-based serverless
              architectures that reduced resource costs by 80% — recognized by
              Senior Vice Presidents, Senior Architects, and Project Managers.
            </p>{" "}
            ...
            exploring AI innovations to stay at the forefront of technology. I
            am now seeking my next challenge to drive impactful solutions at
            scale.
          </p>
        </div>

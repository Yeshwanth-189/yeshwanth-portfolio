...
const skillsRight = [
  ...
  },
  {
    ...
    title: "CI/CD & Cloud",
    description:
      "Built artifacts and maintained CI/CD pipelines for production and staging environments, improving deployment consistency and speed.Monitored and maintained CI/CD pipelines, ensuring successful code integration, testing, and deployment.Collaborated closely with solution architects to align infrastructure, build processes, and deployment strategies with application requirements.Worked with AWS cloud services to deploy, monitor, and manage applications in scalable environments.",
  },
  {
    id: 7,
